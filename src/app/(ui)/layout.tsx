...
export default function Layout({children}: Props) {
    ...
    return (
        <main className="min-h-screen flex justify-center mx-auto ">
            <section className="hidden lg:flex flex-col sticky top-0 h-screen w-72 px-3 border-r-2 border-gray-600 ">
            ...
            <aside className="hidden lg:flex flex-col gap-6 sticky top-0 h-fit w-96 px-8 py-6 border-l-2 border-gray-600 ">
